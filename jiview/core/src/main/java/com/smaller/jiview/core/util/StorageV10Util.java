...
//            final ServiceURL serviceURL = new ServiceURL(new URL("https://" + accountName + ".blob.core.chinacloudapi.cn"), StorageURL.createPipeline(creds, new PipelineOptions()));
//
...
//            System.out.println("(P)utBlob | (L)istBlobs | (G)etBlob | (D)eleteBlobs | (C)leaning up | SASV(8) | SASV(10)");
...
//                        break;
//                    case "10":
//                        System.out.println("SAS V10");
//                        System.out.println(getSAS());
//                        System.exit(0);
//                        break;
//                    default:
//                        break;
